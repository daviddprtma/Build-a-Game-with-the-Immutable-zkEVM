...
const overrides_1 = require("./config/overrides");
class ERC721Client {
    ...
    async DEFAULT_ADMIN_ROLE(provider, overrides = {}) {
        return await this.contract.connect(provider).DEFAULT_ADMIN_ROLE({ ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async DOMAIN_SEPARATOR(provider, overrides = {}) {
        return await this.contract.connect(provider).DOMAIN_SEPARATOR({ ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the MINTER_ROLE as a string.
     */
    async MINTER_ROLE(provider, overrides = {}) {
        return await this.contract.connect(provider).MINTER_ROLE({ ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the balance of an address as a BigNumber.
     */
    async balanceOf(provider, owner, overrides = {}) {
        return await this.contract.connect(provider).balanceOf(owner, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the baseURI as a string.
     */
    async baseURI(provider, overrides = {}) {
        return await this.contract.connect(provider).baseURI({ ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the contractURI as a string.
     */
    async contractURI(provider, overrides = {}) {
        return await this.contract.connect(provider).contractURI({ ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async eip712Domain(provider, overrides = {}) {
        return await this.contract.connect(provider).eip712Domain({ ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns admin addresses as an array of strings.
     */
    async getAdmins(provider, overrides = {}) {
        return await this.contract.connect(provider).getAdmins({ ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the approved address for a token ID, or zero if no address set.
     */
    async getApproved(provider, tokenId, overrides = {}) {
        return await this.contract.connect(provider).getApproved(tokenId, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the role admin address.
     */
    async getRoleAdmin(provider, role, overrides = {}) {
        return await this.contract.connect(provider).getRoleAdmin(role, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the role member address at a particular index.
     */
    async getRoleMember(provider, role, index, overrides = {}) {
        return await this.contract.connect(provider).getRoleMember(role, index, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the role member count as a BigNumber.
     */
    async getRoleMemberCount(provider, role, overrides = {}) {
        return await this.contract.connect(provider).getRoleMemberCount(role, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns a boolean for whether an account has a particular role.
     */
    async hasRole(provider, role, account, overrides = {}) {
        return await this.contract.connect(provider).hasRole(role, account, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async isApprovedForAll(provider, owner, operator, overrides = {}) {
        return await this.contract
            .connect(provider)
            .isApprovedForAll(owner, operator, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the name of the contract as a string.
     */
    async name(provider, overrides = {}) {
        return await this.contract.connect(provider).name({ ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the owner address of a particular tokenId.
     */
    async ownerOf(provider, tokenId, overrides = {}) {
        return await this.contract.connect(provider).ownerOf(tokenId, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async nonces(provider, tokenId, overrides = {}) {
        return await this.contract.connect(provider).nonces(tokenId, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the operator allowlist as a string.
     */
    async operatorAllowlist(provider, overrides = {}) {
        return await this.contract.connect(provider).operatorAllowlist({ ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async royaltyInfo(provider, _tokenId, _salePrice, overrides = {}) {
        return await this.contract
            .connect(provider)
            .royaltyInfo(_tokenId, _salePrice, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the symbol of the contract as a string.
     */
    async symbol(provider, overrides = {}) {
        return await this.contract.connect(provider).symbol({ ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns the Uniform Resource Identifier (URI) for tokenId token.
     */
    async tokenURI(provider, tokenId, overrides = {}) {
        return await this.contract.connect(provider).tokenURI(tokenId, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns returns the total amount of tokens stored by the contract.
     */
    async totalSupply(provider, overrides = {}) {
        return await this.contract.connect(provider).totalSupply({ ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * Write functions
     */
    ...
    async populateApprove(to, tokenId, overrides = {}) {
        return await this.contract.populateTransaction.approve(to, tokenId, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async populatePermit(spender, tokenId, deadline, sig, overrides = {}) {
        return await this.contract.populateTransaction.permit(spender, tokenId, deadline, sig, {
            ...overrides_1.defaultGasOverrides,
            ...overrides,
        });
    }
    /**
    ...
    async populateBurn(tokenId, overrides = {}) {
        return await this.contract.populateTransaction.burn(tokenId, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns a populated transaction for the batch burn contract function
     */
    async populateBurnBatch(tokenIds, overrides = {}) {
        return await this.contract.populateTransaction.burnBatch(tokenIds, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns a populated transaction for the safe burn contract function
     */
    async populateSafeBurn(owner, tokenId, overrides = {}) {
        return await this.contract.populateTransaction.safeBurn(owner, tokenId, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns a populated transaction for the safe burn batch contract function
     */
    async populateSafeBurnBatch(burns, overrides = {}) {
        return await this.contract.populateTransaction.safeBurnBatch(burns, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns a populated transaction for the grantMinterRole contract function
     */
    async populateGrantMinterRole(user, overrides = {}) {
        return await this.contract.populateTransaction.grantMinterRole(user, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns a populated transaction for the grantRole contract function
     */
    async populateGrantRole(role, account, overrides = {}) {
        return await this.contract.populateTransaction.grantRole(role, account, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async populateSafeMint(to, tokenId, overrides = {}) {
        return await this.contract.populateTransaction.safeMint(to, tokenId, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async populateMintBatchByQuantity(mints, overrides = {}) {
        return await this.contract.populateTransaction.mintBatchByQuantity(mints, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async populateMintBatch(mints, overrides = {}) {
        return await this.contract.populateTransaction.mintBatch(mints, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async populateSafeMintBatch(mints, overrides = {}) {
        return await this.contract.populateTransaction.safeMintBatch(mints, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async populateRevokeMinterRole(user, overrides = {}) {
        return await this.contract.populateTransaction.revokeMinterRole(user, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns a populated transaction for the revokeRole contract function
     */
    async populateRevokeRole(role, account, overrides = {}) {
        return await this.contract.populateTransaction.revokeRole(role, account, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async "populateSafeTransferFrom(address,address,uint256,bytes)"(from, to, tokenId, data, overrides = {}) {
        return await this.contract.populateTransaction["safeTransferFrom(address,address,uint256,bytes)"](from, to, tokenId, data, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async populateSetBaseURI(baseURI_, overrides = {}) {
        return await this.contract.populateTransaction.setBaseURI(baseURI_, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
