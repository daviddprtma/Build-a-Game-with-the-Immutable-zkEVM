...
class ERC20Client {
    ...
    async totalSupply(provider, overrides = {}) {
        return this.contract.connect(provider).totalSupply({ ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async balanceOf(provider, account, overrides = {}) {
        return this.contract.connect(provider).balanceOf(account, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
    ...
    async allowance(provider, owner, spender, overrides = {}) {
        return this.contract.connect(provider).allowance(owner, spender, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns a promise that resolves with a populated transaction
     */
    async populateTransfer(to, amount, overrides = {}) {
        return this.contract.populateTransaction.transfer(to, amount, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns a promise that resolves with a populated transaction
     */
    async populateApprove(spender, amount, overrides = {}) {
        return this.contract.populateTransaction.approve(spender, amount, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
    /**
     * @returns a promise that resolves with a populated transaction
     */
    async populateTransferFrom(from, to, amount, overrides = {}) {
        return this.contract.populateTransaction.transferFrom(from, to, amount, { ...overrides_1.defaultGasOverrides, ...overrides });
    }
}
