...
describe("Allowlisted ERC721 Transfers", function () {
    ...
    beforeEach(async function () {
        ...
        ({ erc721, walletFactory, factory, operatorAllowlist, marketPlace } = await (0, DeployRegularFixtures_1.RegularAllowlistFixture)(owner));
        // Deploy the wallet fixture
        ({ deployedAddr, moduleAddress } = await (0, DeployRegularFixtures_1.walletSCFixture)(scWallet, walletFactory));
        // Set up roles
    ...
    describe("Operator Allowlist Registry setting", function () {
        ...
        it("Should not allow contracts that do not implement the IOperatorAllowlist to be set", async function () {
            ...
            const factory = await hardhat_1.ethers.getContractFactory("ImmutableERC721MintByID");
    ...
    describe("Approvals", function () {
        it("Should not allow a non-Allowlisted operator to be approved", async function () {
            ...
            // Approve for all
            await (0, chai_1.expect)(erc721.connect(minter).setApprovalForAll(marketPlace.address, true))
        ...
        it("Not allowlisted contracts should not be able to approve", async function () {
            ...
            await (0, chai_1.expect)(marketPlace.connect(minter).executeApproveForAll(minter.address, true))
        ...
        it("Should allow EOAs to be approved", async function () {
            ...
            (0, chai_1.expect)(await erc721.getApproved(3)).to.be.equal(accs[0].address);
        ...
        it("Should allow Allowlisted addresses to be approved", async function () {
            ...
            (0, chai_1.expect)(await erc721.getApproved(2)).to.be.equal(marketPlace.address);
        ...
        it("Should allow Allowlisted smart contract wallets to be approved", async function () {
            ...
            (0, chai_1.expect)(await erc721.getApproved(3)).to.be.equal(deployedAddr);
    ...
    describe("Transfers", function () {
        ...
        it("Should block transfers from a not allow listed contracts", async function () {
            ...
            await (0, chai_1.expect)(marketPlace.connect(minter).executeTransferFrom(marketPlace.address, minter.address, 5))
    ...
    describe("Malicious Contracts", function () {
        ...
        it("EOA disguise approve", async function () {
            ...
            const { deployedAddr, salt, constructorByteCode } = await (0, DeployRegularFixtures_1.disguidedEOAFixture)(erc721.address, factory, "0x1234");
