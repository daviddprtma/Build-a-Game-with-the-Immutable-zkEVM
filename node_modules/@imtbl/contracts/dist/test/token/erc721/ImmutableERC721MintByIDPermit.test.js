...
describe("ImmutableERC721MintByIDPermit", function () {
    ...
    before(async function () {
        ...
        ({ erc721, operatorAllowlist, eip1271Wallet } = await (0, DeployRegularFixtures_1.RegularAllowlistFixture)(owner));
        // Set up roles
    ...
    describe("Smart Contract Permit", async function () {
        ...
        it("allows approved operators to create permits on behalf of token owner", async function () {
            ...
            await (0, chai_1.expect)(erc721.connect(operator).permit(operatorAddress, 7, deadline, signature)).to.be.revertedWith("InvalidSignature");
            (0, chai_1.expect)(await erc721.getApproved(7)).to.not.equal(operatorAddress);
