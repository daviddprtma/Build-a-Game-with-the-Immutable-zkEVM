...
exports.disguidedEOAFixture = exports.walletSCFixture = exports.AllowlistFixture = void 0;
...
// - Allowlist registry
// - Mock market place
const AllowlistFixture = async (owner) => {
    ...
    // ERC721
    const erc721PresetFactory = (await hardhat_1.ethers.getContractFactory("ImmutableERC721"));
...
exports.AllowlistFixture = AllowlistFixture;
