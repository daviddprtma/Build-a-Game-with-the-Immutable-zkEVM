...
declare const CreateProjectGroupRequestChainTypeEnum: {
    readonly Starkex: "starkex";
    readonly Zkevm: "zkevm";
};
declare type CreateProjectGroupRequestChainTypeEnum = typeof CreateProjectGroupRequestChainTypeEnum[keyof typeof CreateProjectGroupRequestChainTypeEnum];
 ...
 * @export
 */
declare type EncodeAssetRequestTokenData = EncodeAssetTokenData;
 ...
 * @export
 */
declare type SignableTransferDetailsToken = SignableToken;
...
declare const ProjectsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getSdkVersion: (details: string, version?: string, id?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
declare const ProjectsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getSdkVersion(details: string, version?: string, id?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiSDKVersionCheckResponse>>;
};
/**
...
declare class ProjectsApi extends BaseAPI {
     ...
     * @memberof ProjectsApi
     */
    getSdkVersion(requestParameters: ProjectsApiGetSdkVersionRequest, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<ApiSDKVersionCheckResponse, any>>;
}
...
declare const TransfersApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getSignableTransfer: (getSignableTransferRequestV2: GetSignableTransferRequestV2, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSignableTransferV1: (getSignableTransferRequest: GetSignableTransferRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listTransfers: (pageSize?: number, cursor?: string, orderBy?: 'transaction_id' | 'created_at' | 'sender_ether_key' | 'receiver_ether_key', direction?: string, user?: string, receiver?: string, status?: 'success' | 'failure', minTimestamp?: string, maxTimestamp?: string, tokenType?: string, tokenId?: string, assetId?: string, tokenAddress?: string, tokenName?: string, minQuantity?: string, maxQuantity?: string, metadata?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
declare const TransfersApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createTransfer(createTransferRequestV2: CreateTransferRequest, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateTransferResponseV2>>;
    /**
     * Create a new transfer request. Use https://docs.x.immutable.com/reference#/operations/getSignableTransferV1 to get request body params.
     * @summary Creates a transfer of tokens between two parties
     * @param {CreateTransferRequestV1} createTransferRequest Create transfer
     ...
     * @throws {RequiredError}
     */
    getSignableTransfer(getSignableTransferRequestV2: GetSignableTransferRequestV2, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetSignableTransferResponseV2>>;
    /**
     * Gets details of a signable transfer
     * @summary Gets details of a signable transfer
     * @param {GetSignableTransferRequest} getSignableTransferRequest get details of signable transfer
     ...
     * @throws {RequiredError}
     */
    getSignableTransferV1(getSignableTransferRequest: GetSignableTransferRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetSignableTransferResponseV1>>;
    /**
     * Get details of a transfer with the given ID
     * @summary Get details of a transfer with the given ID
     * @param {string} id Transfer ID
     ...
     * @throws {RequiredError}
     */
    listTransfers(pageSize?: number, cursor?: string, orderBy?: 'transaction_id' | 'created_at' | 'sender_ether_key' | 'receiver_ether_key', direction?: string, user?: string, receiver?: string, status?: 'success' | 'failure', minTimestamp?: string, maxTimestamp?: string, tokenType?: string, tokenId?: string, assetId?: string, tokenAddress?: string, tokenName?: string, minQuantity?: string, maxQuantity?: string, metadata?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListTransfersResponse>>;
};
/**
...
declare class TransfersApi extends BaseAPI {
     ...
     */
    createTransfer(requestParameters: TransfersApiCreateTransferRequest, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<CreateTransferResponseV2, any>>;
    /**
     * Create a new transfer request. Use https://docs.x.immutable.com/reference#/operations/getSignableTransferV1 to get request body params.
     * @summary Creates a transfer of tokens between two parties
     ...
     * @memberof TransfersApi
     */
    getSignableTransfer(requestParameters: TransfersApiGetSignableTransferRequest, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<GetSignableTransferResponseV2, any>>;
    /**
     * Gets details of a signable transfer
     * @summary Gets details of a signable transfer
...
declare const UsersApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    registerPassportUser(authorization: string, registerPassportUserRequest: ApiRegisterPassportUserRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RegisterPassportUserResult>>;
    /**
     * Registers a user
     * @summary Registers a user
     * @param {RegisterUserRequest} registerUserRequest Register User
...
declare class UsersApi extends BaseAPI {
     ...
     * @memberof UsersApi
     */
    registerPassportUser(requestParameters: UsersApiRegisterPassportUserRequest, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<RegisterPassportUserResult, any>>;
    /**
     * Registers a user
     * @summary Registers a user
